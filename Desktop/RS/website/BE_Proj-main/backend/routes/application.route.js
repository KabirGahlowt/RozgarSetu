...
import { applyJobs, getAppliedJobs, getApplicants, updateStatus, hireWorker, hireAgain, getHireRequestsForWorker, getHiredWorkersForClient, updateHireStatus } from "../controllers/application.controller.js";
...
router.route("/hireAgain/:id").post(isAuthenticated,hireAgain);
